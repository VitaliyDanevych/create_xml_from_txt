...
writefile.writelines('<!DOCTYPE Model SYSTEM "/opt/ericsson/arne/etc/arne14_1.dtd">'+ '\n') 
writefile.writelines('<Model version="1" importVersion="14.1">'+ '\n')
...
with open('to_create.txt', 'rb') as csvfile:
        ...
        for row in reader:
            ...
            writefile.writelines('               '+ '<AssociableNode TO_FDN="ManagedElement=KIEB5,BssFunction=BSS_ManagedFunction" FROM_FDN="SubNetwork=IPRAN,ManagedElement=' + full_s_name + ',StnFunction=STN_ManagedFunction" AssociationType="StnFunction_to_BssFunction"/>'+ '\n')
            writefile.writelines('               '+ '<AssociableNode TO_FDN="ManagedElement=KIEB5,BssFunction=BSS_ManagedFunction,BtsSiteMgr=' + site_name + '" FROM_FDN="SubNetwork=IPRAN,ManagedElement=' + full_s_name +',StnFunction=STN_ManagedFunction" AssociationType="StnFunction_to_BtsSiteMgr"/>'+ '\n')
...
print 'For check xml file use: ' + '/opt/ericsson/arne/bin/import.sh -f /tmp/siu/to_create.xml -val:rall' + '\n'
print 'For start xml file use: ' + '/opt/ericsson/arne/bin/import.sh -import -f /tmp/siu/to_create.xml' + '\n'
